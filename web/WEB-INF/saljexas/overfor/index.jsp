...
--%>
        ...
        <form method="post">
            Ange en lista med ordernr från Saljex AS, separerade med kommatecken (,):<br><textarea name="orderlista" rows="10" cols="60"><%= request.getParameter("orderlista") %></textarea> 
