...
<table style="margin-top: 2em; width: 100%; border-top: 1px solid black; border-bottom: 1px solid black; padding-top: 2px; padding-bottom: 2px;">
    <tr><th style="width: 60px;"></th><th style="width: 8em"><%= t.t("Artikelnr") %></th><th style="width: 18em"><%= t.t("Benämning") %></th><th style="width: 7em; text-align: right;"><%= t.t("Antal") %></th><th></th><th style="text-align: right;"><%= t.t("Pris") %></th><th>%</th><th style="text-align: right;"><%= t.t("Summa") %></th></tr>
